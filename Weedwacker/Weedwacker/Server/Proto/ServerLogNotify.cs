...
namespace Weedwacker.Server.Proto {
    ...
    static ServerLogNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "VHlwZRIiCglsb2dfbGV2ZWwYDyABKA4yDy5TZXJ2ZXJMb2dMZXZlbEIaqgIX",
            "V2VlZHdhY2tlci5TZXJ2ZXIuUHJvdG9iBnByb3RvMw=="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { global::Weedwacker.Server.Proto.ServerLogLevelReflection.Descriptor, global::Weedwacker.Server.Proto.ServerLogTypeReflection.Descriptor, },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Weedwacker.Server.Proto.ServerLogNotify), global::Weedwacker.Server.Proto.ServerLogNotify.Parser, new[]{ "ServerLog", "LogType", "LogLevel" }, null, null, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Weedwacker.Server.Proto.ServerLogNotifyReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::Weedwacker.Server.Proto.ServerLogType logType_ = global::Weedwacker.Server.Proto.ServerLogType.None;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Weedwacker.Server.Proto.ServerLogType LogType {
      get { return logType_; }
      set {
        logType_ = value;
      }
    ...
    private global::Weedwacker.Server.Proto.ServerLogLevel logLevel_ = global::Weedwacker.Server.Proto.ServerLogLevel.None;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Weedwacker.Server.Proto.ServerLogLevel LogLevel {
    ...
    public override int GetHashCode() {
      ...
      if (LogType != global::Weedwacker.Server.Proto.ServerLogType.None) hash ^= LogType.GetHashCode();
      if (LogLevel != global::Weedwacker.Server.Proto.ServerLogLevel.None) hash ^= LogLevel.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (LogType != global::Weedwacker.Server.Proto.ServerLogType.None) {
        output.WriteRawTag(72);
        output.WriteEnum((int) LogType);
      }
      if (LogLevel != global::Weedwacker.Server.Proto.ServerLogLevel.None) {
    ...
    public void MergeFrom(ServerLogNotify other) {
      ...
      if (other.LogType != global::Weedwacker.Server.Proto.ServerLogType.None) {
        LogType = other.LogType;
      }
      if (other.LogLevel != global::Weedwacker.Server.Proto.ServerLogLevel.None) {
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 72: {
            LogType = (global::Weedwacker.Server.Proto.ServerLogType) input.ReadEnum();
            break;
          }
          case 120: {
            LogLevel = (global::Weedwacker.Server.Proto.ServerLogLevel) input.ReadEnum();
            break;
          }
        }
      }
