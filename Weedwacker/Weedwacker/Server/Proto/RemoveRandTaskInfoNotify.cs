...
namespace Weedwacker.Server.Proto {
    ...
    static RemoveRandTaskInfoNotifyReflection() {
      byte[] descriptorData = global::System.Convert.FromBase64String(
          string.Concat(
            ...
            "RklOSVNIEANCGqoCF1dlZWR3YWNrZXIuU2VydmVyLlByb3RvYgZwcm90bzM="));
      descriptor = pbr::FileDescriptor.FromGeneratedCode(descriptorData,
          new pbr::FileDescriptor[] { },
          new pbr::GeneratedClrTypeInfo(null, null, new pbr::GeneratedClrTypeInfo[] {
            new pbr::GeneratedClrTypeInfo(typeof(global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify), global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Parser, new[]{ "IsSucc", "Reason", "RandTaskId" }, null, new[]{ typeof(global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason) }, null, null)
          }));
    }
    #endregion
  ...
  #endif
  {
    ...
    public static pbr::MessageDescriptor Descriptor {
      get { return global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotifyReflection.Descriptor.MessageTypes[0]; }
    }
    ...
    private global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason reason_ = global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason.Default;
    [global::System.Diagnostics.DebuggerNonUserCodeAttribute]
    [global::System.CodeDom.Compiler.GeneratedCode("protoc", null)]
    public global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason Reason {
      get { return reason_; }
      set {
        reason_ = value;
      }
    ...
    public override int GetHashCode() {
      ...
      if (Reason != global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason.Default) hash ^= Reason.GetHashCode();
    ...
    public void WriteTo(pb::CodedOutputStream output) {
      ...
      if (Reason != global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason.Default) {
    ...
    public void MergeFrom(RemoveRandTaskInfoNotify other) {
      ...
      if (other.Reason != global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason.Default) {
        Reason = other.Reason;
      }
    ...
    public void MergeFrom(pb::CodedInputStream input) {
      ...
      while ((tag = input.ReadTag()) != 0) {
        switch(tag) {
          ...
          case 80: {
            Reason = (global::Weedwacker.Server.Proto.RemoveRandTaskInfoNotify.Types.FinishReason) input.ReadEnum();
            break;
          }
          case 104: {
