...
namespace Weedwacker.WebServer.Handlers
{
    internal class GetAnnContent : IHandler
    {
        public class GetAnnContentResJson
        {
            ...
            public GetAnnContentResJson(Data dataa)
            { 
                data = dataa;
            }
        }
        public async Task<bool> HandleAsync(HttpContext context)
        {
            ...
            GetAnnContentResJson.Data data;
            ...
            {
                data = JsonConvert.DeserializeObject<GetAnnContentResJson.Data>(await File.ReadAllTextAsync(WebServer.Configuration.structure.data + "GameAnnouncement.json"));
            }
            
            await context.Response.WriteAsJsonAsync(new GetAnnContentResJson(data));
            return true;
        } 
    }
}
